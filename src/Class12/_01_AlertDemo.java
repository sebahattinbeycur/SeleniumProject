...
public class _01_AlertDemo {
    public static void main(String[] args) throws InterruptedException {
        ...
        promptAlert.sendKeys("Sebahattin");                       // I am sending text/value into the input text box.
        Thread.sleep(2000);
        promptAlert.accept();                                         // Press OK button to close the alert
        Thread.sleep(2000);

// Let's verify our entered text
        String enteredText = driver.findElement(By.xpath("//div[contains(text(),'Sebahattin')]")).getText();
        System.out.println("enteredText: " + enteredText);

        String expectedText = "Sebahattin";                              // For negative testing, only change here, add sth at the end.

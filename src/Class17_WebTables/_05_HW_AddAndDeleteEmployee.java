...
public class _05_HW_AddAndDeleteEmployee extends BaseClass {
    ...
    public static void main(String[] args) {
        ...
        sendText(driver.findElement(By.xpath("//input[@id='txtUsername']")), ConfigsReader.getProperties("username"));
        sendText(driver.findElement(By.xpath("//input[@id='txtPassword']")), ConfigsReader.getProperties("password"));
        clickRadioOrCheckbox(driver.findElement(By.id("btnLogin")));
...
//        driver.findElement(By.id("menu_pim_viewEmployeeList")).click();       //  Verify employee has been added (By retrieving Employee ID).
